...
public class RobustHMM {
     ...
     * @param n an integer representing the number of distributions in the
     * Observation data
     */
     ...
     *
     * @return an Array of integers representing the state assignments after
     * decoding
     */
     ...
     *
     * @return a List of List of ObservationVector representing the data for
     * baum welch training
     */
    @SuppressWarnings("unchecked")
     ...
     * Format the data as multivariate gaussian data
     *
     * @return a List of ObservationVector representing the data for viterbi
     * decoding
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @return a List of List of ObservationReal representing the data for baum
     * welch training
     */
    @SuppressWarnings("unchecked")
     ...
     * Format the data as double data
     *
     * @return a List of ObservationReal representing the data for viterbi
     * decoding
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @return a List of List of ObservationInteger representing the data for
     * baum welch training
     */
    @SuppressWarnings("unchecked")
     ...
     * Format the data as integer data
     *
     * @return a List of ObservationInteger representing the data for viterbi
     * decoding
     */
    @SuppressWarnings("unchecked")
